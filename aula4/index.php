    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <?php endif; ?>
                <form id="formulario" class="navbar-form navbar-left">
                    <div class="form-group">
                        <input id="barraBusca" type="text" class="form-control" placeholder="Pesquisar...">
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="validarCompra.php" method="post">
                                    ...
                                    <input type="hidden" name="preco" value="<?php echo $infos[2] ?>">
                                    ...
                                    <div class="input-group col-md-5">
                                        ...
                                        <input id="labelNroCartao" type="number" name="nroCartao" class="form-control" placeholder="Digite Aqui...">
                                    </div>
