            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <h4>Curso de <?php echo $nome ?>.</h4>
                  <h4>Valor: R$ <?php echo $infos[2] ?></h4>
                  <form class="" action="" method="">
                    <div class="input-group col-xs-5 col-sm-5 col-md-5 col-lg-5">
                      <label for="labelNome">Nome Completo</label>
                      <input id="labelNome" type="text" class="form-control" placeholder="Digite Aqui...">
                    </div>

                    <div class="input-group col-xs-5 col-sm-5 col-md-5 col-lg-5">
                      <label for="labelCpf">CPF</label>
                      <input id="labelCpf" type="number" class="form-control" placeholder="Digite Aqui...">
                    </div>

                    <div class="input-group col-xs-5 col-sm-5 col-md-5 col-lg-5">
                      <label for="labelNroCartao">Número do Cartão</label>
                      <input id="labelNroCartao" type="number" class="form-control" placeholder="Digite Aqui...">
                    </div>

                    <div class="input-group col-xs-5 col-sm-5 col-md-5 col-lg-5">
                      <label for="labelValidade">Validade</label>
                      <input id="labelValidade" type="month" class="form-control" placeholder="Digite Aqui...">
                    </div>

                    <div class="input-group col-xs-5 col-sm-5 col-md-5 col-lg-5">
                      <label for="labelCvv">CVV</label>
                      <input id="labelCvv" type="number" class="form-control" placeholder="Digite Aqui...">
                    </div>
